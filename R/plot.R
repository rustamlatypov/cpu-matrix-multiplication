...
base = c(1.43, 31.24, 135.16, 372.68, 812.09, 1454.66, 2604.8, 5037) + 1
para = c(0.0172, 0.121, 0.403, 0.946, 2.17, 3.87, 6.72, 12.38) + 1
...
plot(data$n, data$base, type="b", xlab = "n", ylab = "seconds", bty = "n", log = "y",
     lwd = 1.6, cex = 1.2, cex.axis = 1.3, cex.lab = 1.3, ylim=c(0.9,3000))
