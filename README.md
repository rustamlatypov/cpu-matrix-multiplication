...
### CPU usage
With FMA instructions the platform is able to perform ≈230*10^9 double-precision floating point operations per second. Since matrix multiplication takes 2*n^3 floating point operations, the cpu usage for running time `t` is given by 2*n^3/t/230*10^9. 
